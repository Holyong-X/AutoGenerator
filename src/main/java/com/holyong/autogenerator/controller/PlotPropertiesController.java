...
@Api(value = "", tags = "")
@RestController
@RequestMapping("plot-properties")
public class PlotPropertiesController {

    @Autowired
    private PlotPropertiesService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) PlotProperties entity) {
        Page<PlotProperties> pageParam = new Page<>(current, limit);
        QueryWrapper<PlotProperties> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<PlotProperties> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        PlotProperties entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody PlotProperties entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody PlotProperties entity) {
