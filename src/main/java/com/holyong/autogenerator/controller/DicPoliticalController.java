...
@Api(value = "", tags = "")
@RestController
@RequestMapping("dic-political")
public class DicPoliticalController {

    @Autowired
    private DicPoliticalService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) DicPolitical entity) {
        Page<DicPolitical> pageParam = new Page<>(current, limit);
        QueryWrapper<DicPolitical> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<DicPolitical> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        DicPolitical entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody DicPolitical entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody DicPolitical entity) {
