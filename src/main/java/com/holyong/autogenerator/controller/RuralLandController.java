...
@Api(value = "", tags = "")
@RestController
@RequestMapping("rural-land")
public class RuralLandController {

    @Autowired
    private RuralLandService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) RuralLand entity) {
        Page<RuralLand> pageParam = new Page<>(current, limit);
        QueryWrapper<RuralLand> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<RuralLand> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        RuralLand entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody RuralLand entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody RuralLand entity) {
