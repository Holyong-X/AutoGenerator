...
@Api(value = "", tags = "")
@RestController
@RequestMapping("dic-gbnation")
public class DicGbnationController {

    @Autowired
    private DicGbnationService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) DicGbnation entity) {
        Page<DicGbnation> pageParam = new Page<>(current, limit);
        QueryWrapper<DicGbnation> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<DicGbnation> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        DicGbnation entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody DicGbnation entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody DicGbnation entity) {
