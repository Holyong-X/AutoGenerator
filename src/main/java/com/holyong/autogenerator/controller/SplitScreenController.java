...
@Api(value = "", tags = "")
@RestController
@RequestMapping("split-screen")
public class SplitScreenController {

    @Autowired
    private SplitScreenService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) SplitScreen entity) {
        Page<SplitScreen> pageParam = new Page<>(current, limit);
        QueryWrapper<SplitScreen> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<SplitScreen> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        SplitScreen entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody SplitScreen entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody SplitScreen entity) {
