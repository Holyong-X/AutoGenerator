...
@Api(value = "", tags = "")
@RestController
@RequestMapping("dic-grade-level")
public class DicGradeLevelController {

    @Autowired
    private DicGradeLevelService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) DicGradeLevel entity) {
        Page<DicGradeLevel> pageParam = new Page<>(current, limit);
        QueryWrapper<DicGradeLevel> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<DicGradeLevel> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        DicGradeLevel entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody DicGradeLevel entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody DicGradeLevel entity) {
