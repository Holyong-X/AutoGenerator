...
import com.holyong.autogenerator.entity.DicStudentstatus;
import com.holyong.autogenerator.service.DicStudentstatusService;
...
@Api(value = "", tags = "")
@RestController
@RequestMapping("dic-studentstatus")
public class DicStudentstatusController {

    @Autowired
    private DicStudentstatusService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) DicStudentstatus entity) {
        Page<DicStudentstatus> pageParam = new Page<>(current, limit);
        QueryWrapper<DicStudentstatus> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<DicStudentstatus> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        DicStudentstatus entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody DicStudentstatus entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody DicStudentstatus entity) {
