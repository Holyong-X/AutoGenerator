...
import com.holyong.autogenerator.entity.GardenStatistics;
import com.holyong.autogenerator.service.GardenStatisticsService;
 ...
 * @description 菜园统计控制器
 */
@Api(value = "菜园统计", tags = "菜园统计")
@RestController
@RequestMapping("garden-statistics")
public class GardenStatisticsController {

    @Autowired
    private GardenStatisticsService targetService;
    ...
    * @return
    */
    @ApiOperation(value = "获取菜园统计分页列表", notes = "获取菜园统计分页列表")
    @GetMapping(value = "{page}/{limit}")
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            @PathVariable Long current,
            @ApiParam(name = "limit", value = "每页记录数", required = true)
            @PathVariable Long limit,
            @RequestBody(required = false) GardenStatistics entity) {
        Page<GardenStatistics> pageParam = new Page<>(current, limit);
        QueryWrapper<GardenStatistics> wrapper = new QueryWrapper<>();
    ...
    * 查找所有记录数
    */
    @ApiOperation(value = "获取菜园统计的所有数据")
    @GetMapping("/findAll")
    public ResponseResult findAll() {
        List<GardenStatistics> list = targetService.list();
        if (list != null){
     ...
     * 根据ID查找数据
     */
    @ApiOperation(value = "获取菜园统计详情", notes = "根据ID获取菜园统计详情")
    @GetMapping("/get")
    public ResponseResult get(@RequestParam("id") String id) {
        GardenStatistics entity = targetService.getById(id);
        if (entity != null){
     ...
     * @return
     */
    @ApiOperation(value = "新增菜园统计", notes = "新增菜园统计")
    @PostMapping("/add")
    public ResponseResult add(@RequestBody GardenStatistics entity) {
     ...
     * @return
     */
    @ApiOperation(value = "编辑菜园统计", notes = "编辑菜园统计")
    @PostMapping("/update")
    public ResponseResult update(@RequestBody GardenStatistics entity) {
    ...
    * @return
    */
    @ApiOperation(value = "移除菜园统计", notes = "移除菜园统计")
    ...
    * @return
    */
    @ApiOperation(value = "批量移除菜园统计", notes = "批量移除菜园统计 多个参数用,号隔开")
    @ApiResponses({
