...
@Api(value = "", tags = "")
@RestController
@RequestMapping("dic-marital")
public class DicMaritalController {

    @Autowired
    private DicMaritalService targetService;
    ...
    */
    ...
    public ResponseResult list( @ApiParam(name = "current", value = "当前页码", required = true)
            ...
            @RequestBody(required = false) DicMarital entity) {
        Page<DicMarital> pageParam = new Page<>(current, limit);
        QueryWrapper<DicMarital> wrapper = new QueryWrapper<>();
    ...
    */
    ...
    public ResponseResult findAll() {
        List<DicMarital> list = targetService.list();
        if (list != null){
    ...
    public ResponseResult get(@RequestParam("id") String id) {
        DicMarital entity = targetService.getById(id);
        if (entity != null){
    ...
    @PostMapping("/add")
    public ResponseResult add(@RequestBody DicMarital entity) {
    ...
    @PostMapping("/update")
    public ResponseResult update(@RequestBody DicMarital entity) {
